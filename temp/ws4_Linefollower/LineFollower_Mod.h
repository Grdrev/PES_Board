/**
 * @file LineFollower_Mod.h
 * @brief This file defines the LineFollower class.
 * @author M. Peter / pmic / pichim
 */

#ifndef LINE_FOLLOWER_MOD_H_
#define LINE_FOLLOWER_MOD_H_        
...
public:
    ...
    //   /**
    //  * @brief raw sensor bar data stream to console.
    //  * @return Prints Stream to console.
    //  */
    // void SensorBarStream();
